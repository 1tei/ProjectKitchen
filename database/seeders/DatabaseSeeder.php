...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('Video')->insert([
            ...
            'Video_link' => 'https://www.youtube.com/watch?v=aw22j8M048w',
            'created_at' => $time,
            'updated_at' => $time,
            'Views' => '5425',
        ]);
        ...
        DB::table('Video')->insert([
            ...
            'Video_link' => 'https://www.youtube.com/watch?v=IJou15msogM',
            'created_at' => $time,
            'updated_at' => $time,
            'Views' => '129',
        ]);
        ...
        DB::table('Video')->insert([
            ...
            'Video_link' => 'https://www.youtube.com/watch?v=z3xDriIV7gI',
            'created_at' => $time,
            'updated_at' => $time,
            'Views' => '1259',
        ]);
